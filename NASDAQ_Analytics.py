...
import cx_Oracle
import os
##os.environ['ORACLE_HOME'] ="D:\\app\User\product\\11.2.0\dbhome_1"
import cx_Oracle
import os
...
for i in symbol_input_lis:
    ...
    if PRE_EPS==None or PRE_EPS[0]==None:
        PRE_EPS=(0,0)
    ...
    if CURR_EPS==None or CURR_EPS[0]==None:
        CURR_EPS=(0,0)
        print 'entered curreps'
    ## ---- 19. Revenue   caulculation --- ###
    ...
    if CURR_R==None or CURR_R[0]==None:
        CURR_R=(0,0)
        print 'entered currr'
