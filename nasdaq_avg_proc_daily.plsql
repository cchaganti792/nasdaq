...
DBMS_OUTPUT.PUT_LINE('symbol is   '||in_symbol||' '||v_PRIVCLOSE);
        OPEN C2 (v_tradedate1,in_symbol);
            ...
            insert into nasdaq.nasdaq_avg (SYMBOL,TRADEDATE,PRIVCLOSE,OPEN,CURRENTPRICE,PRCNT_CHANGE,FIVEDAYAVGPRI,TWENTYAVGPRI,FIFTYAVGPRI,ONEFIFTYAVGPRI,TWOHUNAVGPRI,CURRENTVOL,FIVEDAYVOL,TWENTYAVGVOL,FIFTYAVGVOL,ONEFIFTYAVGVOL) values (v_symbol,v_tradedate1,v_PRIVCLOSE,v_OPENPRICE,v_CURRENTPRICE,NVL(TRUNC(((v_CURRENTPRICE-v_PRIVCLOSE)/NULLIF(v_PRIVCLOSE,0))*100,2),0),v_FIVEDAYAVGPRI,v_TWENTYAVGPRI,v_FIFTYAVGPRI,v_ONEFIFTYAVGPRI,v_TWOHUNAVGPRI,v_CURRENTVOL/100000,v_FIVEDAYVOL/100000,v_TWENTYAVGVOL/100000,v_FIFTYAVGVOL/100000,v_ONEFIFTYAVGVOL/100000);
            END LOOP;
            commit;
        close C2;
        END LOOP;
